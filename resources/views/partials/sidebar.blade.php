        ...
        <li class="c-sidebar-nav-title">{{ __('Manage Checklists') }}</li>
            ...
            <li class="c-sidebar-nav-item c-sidebar-nav-dropdown c-show">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    ...
                    <li class="c-sidebar-nav-item">
                        <a class="c-sidebar-nav-link"
                        href="{{ route('admin.checklist-groups.checklists.create', $group->id) }}">{{ __('New Checklist') }}</a>
                    </li>
                </ul>
            </li>
            ...
            @endforeach
            <li class="c-sidebar-nav-item c-sidebar-nav-dropdown">
                <a class="c-sidebar-nav-link" href="{{ route('admin.checklist-groups.create') }}">{{ __('New Checklist Group') }}</a>
            </li>
        @endif
